...
namespace TimeRulerLibrary
{
    ...
    public enum AppendNumberOptions
    {
        ...
        // Insert Number goupr separation characters.
    ...
    /// One of them is boxing ocurred when you use StringBuilder.AppendFormat method.
    /// Another issue is memory allocation occured when you specify int or float for
