...
namespace TimeRulerLibrary
{
    ...
    public static class KeyboardUtils
    {
        ...
        /// <param name="shitKeyPressed">Is shitf key pressed?</param>
        /// <param name="character">Converted character from key input.</param>
        /// <returns>It returns true when it can get a character</returns>
        ...
        /// <param name="charPair">
        /// Character, If it is two characters, first character for without shift key,
        /// second character for with shift key.</param>
