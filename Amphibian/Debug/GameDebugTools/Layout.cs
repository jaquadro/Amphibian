...
namespace TimeRulerLibrary
{
    ...
    /// </summary>
    /// <remarks>
    /// You have to support various resolution when you develop multi-platform
    ...
    /// 
    /// Margin is parcentage of client area size.
    /// 
    /// Exmpale:
    /// 
    ...
    /// So, it is useful when you have split screen game which layout happends based
    /// on client and it takes carea of the safe at same time.
    /// 
    /// </remarks>
