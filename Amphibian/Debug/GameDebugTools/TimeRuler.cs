...
namespace TimeRulerLibrary
{
    ...
    /// by using this tool.
    /// Because of this is real time profile, you can find gritches in the game too.
    /// 
    ...
    ///  * Multithreaded safe
    ///  * Automatically changes display frames based on fram duration.
    ///  
    /// How to use:
    ...
    /// 
    /// All profilring methods has CondionalAttribute with "TRACE".
    ...
    public class TimeRuler : DrawableGameComponent
    {
        ...
        // Dictionaly that maps from marker name to marker id.
        ...
        public void Draw( Vector2 position, int width )
        {
            ...
            // For example, if entire process of frame doesn't finished less than 16.6ms
            // for while, it adjust display frame duration as 33.3ms.
