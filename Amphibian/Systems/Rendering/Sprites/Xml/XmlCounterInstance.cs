...
{
    public class XmlCounterInstance : ICounterInstance, IXmlSerializable
    {
        public ITransformElement Transform { get; set; }

        public XmlCounterInstance ()
        { }

        public XmlCounterInstance (ICounterInstance animatedSpriteInstance)
        {
